...
namespace Genetic_Algorithm
{
    public partial class UserInput : Form
    {
        ...
        int maxUpperLimit = 1000, maxGenCount = 100, maxInitialPop = 100;
        ...
        private void UpperBoundTB_Leave(object sender, EventArgs e)
        {
            int upperVal = int.Parse(UpperBoundTB.Text);
            int maxBit = Utility.CountMaxBits(upperVal);

            UpperBoundTB.Text = Math.Pow(2, maxBit).ToString();
        }
    }
}
